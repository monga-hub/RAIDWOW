...
function clearProfileJourney(storage){const profile=loadRaidProfile(storage);storage.removeItem(RAID_LEGACY_JOURNEY_KEY);if(!profile)return false;profile.activeJourney=null;profile.selectedRoles=[];profile.initiative=[];return writeRaidProfile(storage,profile)}
