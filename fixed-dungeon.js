...
const GRUMARAT_TEMPLE={
  ...
  start:'gate',
  rooms:[
    {id:'gate',number:1,name:'La Scalinata delle Tre Bocche',kind:'entrance',encounter:['GOBLIN','GOBLIN'],x:49.9,y:92.99,links:['vestibule'],closeup:'assets/ingresso.jpeg?v=1',terrain:'assets/terrain-ingresso-v3.png?v=1',terrainLayout:{rows:4,cols:6,passages:{west:[2,3],east:[2,3]},obstacles:[]}},
    ...
    {id:'tongue-pools',number:5,name:'Le Pozze delle Lingue in Agguato',kind:'pools',encounter:['GOBLIN','WARCHIEF','ENGINEER'],x:16.74,y:47.04,links:['ossuary','high-stairs','four-eyes-chapel','cistern'],closeup:'assets/optimized/dungeon-closeups/05-pozze-lingue-agguato.webp?v=5',terrain:'assets/terrain-pozze-lingue-agguato-v1.png?v=1',terrainLayout:{rows:4,cols:6,passages:{west:[2,3],east:[2,3]},obstacles:[]},key:'Chiave Enrage I'},
    ...
    {id:'high-stairs',number:8,name:'Le Scale del Miasma',kind:'stairs',encounter:['GOBLIN','GOBLIN','ENGINEER','WARCHIEF'],x:49.48,y:39.78,links:['cistern','tongue-pools','root-gallery','skull-sanctum','four-eyes-chapel','throne','ossuary','eye-well'],closeup:'assets/optimized/dungeon-closeups/08-scale-miasma.webp?v=4',terrain:'assets/terrain-scale-miasma-v1.png?v=1',terrainLayout:{rows:4,cols:6,passages:{west:[2,3],east:[2,3]},obstacles:[]}},
