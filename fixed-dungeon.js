...
const GRUMARAT_TEMPLE={
  ...
  rooms:[
    ...
    {id:'deep-gate',number:12,name:'Le Porte di Radicava',kind:'siege',wing:'deep',encounter:['GOBLIN','GOBLIN'],objective:{type:'defense',siege:true,title:'L’Assedio di Radicava',name:'Mura di Radicava',hp:10,wallHp:8,rounds:3,breachCol:1,damagePerEnemy:1,fortifyPower:2,rule:'Cinque segmenti di mura da 8 HP; Fortifica concede +2 Block.',rewardWeapons:3,rewardTier:'SILVER',rewardLabel:'NORMAL',rewardDifficulty:'normale',position:{row:3,col:1},spawnRows:[1,3,5],spawnCols:[5,4],waves:[['GOBLIN','GOBLIN'],['GOBLIN','GOBLIN','ENGINEER'],['GOBLIN','ENGINEER','WARCHIEF']]},links:[],closeup:'assets/stanza-e2-07.jpeg?v=1',terrain:'assets/terrain-e2-07-v1.jpg?v=1',terrainLayout:{rows:5,cols:5,barricadeHp:6,passages:{west:[1,2,3,4,5],east:[1,3,5]},obstacles:[{row:2,col:3},{row:4,col:3}]}},
    {id:'deep-cistern',number:13,name:'Il Ponte delle Cisterne',kind:'siege',wing:'deep-heroic',encounter:['GOBLIN','GOBLIN','ENGINEER'],objective:{type:'defense',siege:true,title:'L’Assedio di Radicava · Fronte delle Cisterne',name:'Mura delle Cisterne',hp:14,wallHp:8,rounds:4,breachCol:1,damagePerEnemy:2,rule:'Cinque segmenti da 8 HP; dal secondo round spuntano i Funghi del Miasma.',rewardWeapons:3,rewardTier:'GOLD',rewardLabel:'HEROIC',rewardDifficulty:'heroic',position:{row:3,col:1},spawnRows:[1,2,4,5],spawnCols:[5,4],waves:[['GOBLIN','GOBLIN','ENGINEER'],['GOBLIN','ENGINEER','ENGINEER'],['GOBLIN','ENGINEER','WARCHIEF'],['ENGINEER','ENGINEER','WARCHIEF']]},links:[],closeup:'assets/stanza-e2-02.jpeg?v=1',terrain:'assets/terrain-e2-02-v1.jpg?v=1',terrainLayout:{rows:5,cols:5,barricadeHp:6,passages:{west:[1,2,3,4,5],east:[1,2,4,5]},obstacles:[{row:1,col:3},{row:5,col:3}]}},
    {id:'deep-roots',number:14,name:'Il Bastione delle Radici',kind:'siege',wing:'deep-hardcore',encounter:['GOBLIN','ENGINEER','WARCHIEF'],objective:{type:'defense',siege:true,title:'L’Assedio di Radicava · Ultimo Bastione',name:'Mura del Bastione',hp:18,wallHp:8,rounds:5,breachCol:1,damagePerEnemy:3,rule:'Cinque segmenti da 8 HP; i Funghi potenziati infliggono 2 Ferite quando esplodono.',rewardWeapons:3,rewardTier:'GOLD2',rewardLabel:'HARDCORE',rewardDifficulty:'hardcore',position:{row:3,col:1},spawnRows:[1,2,3,4,5],spawnCols:[5,4],waves:[['GOBLIN','GOBLIN','ENGINEER'],['GOBLIN','ENGINEER','WARCHIEF'],['ENGINEER','ENGINEER','WARCHIEF'],['GOBLIN','ENGINEER','WARCHIEF','WARCHIEF'],['ENGINEER','WARCHIEF','WARCHIEF','WARCHIEF']]},links:[],closeup:'assets/stanza-e2-05.jpeg?v=1',terrain:'assets/terrain-e2-05-v1.jpg?v=1',terrainLayout:{rows:5,cols:5,barricadeHp:6,passages:{west:[1,2,3,4,5],east:[1,2,3,4,5]},obstacles:[{row:2,col:3},{row:3,col:3},{row:4,col:3}]}}
  ]
};
...
function applyFixedTempleLayout(g,plan){
  ...
  const barricadeHp=Math.max(1,Number(plan.terrainLayout.barricadeHp)||6);
  g.combatGridRows=plan.terrainLayout.rows;g.combatGridCols=plan.terrainLayout.cols;g.combatGridObstacles=structuredClone(plan.terrainLayout.obstacles||[]).map(cell=>{const maxHp=Math.max(1,Number(cell.maxHp??cell.hp)||barricadeHp);return{...cell,hp:maxHp,maxHp}});delete g.combatGridEncounter;return true;
}
