...
const GRUMARAT_TEMPLE={
  id:'grumarat-temple',
  art:'assets/optimized/dungeon-paludi-organic-master.png',
  start:'gate',
  rooms:[
    ...
    {id:'high-stairs',number:8,name:'Le Scale del Miasma',kind:'stairs',x:50,y:37,links:['cistern','tongue-pools','root-gallery','skull-sanctum','four-eyes-chapel'],closeup:'assets/optimized/dungeon-closeups/08-scale-miasma.webp?v=4'},
    {id:'skull-sanctum',number:9,name:'Il Santuario dei Teschi Sommersi',kind:'sanctuary',x:75,y:18,links:['high-stairs','throne'],closeup:'assets/optimized/dungeon-closeups/09-santuario-teschi.webp?v=3'},
    {id:'throne',number:10,name:'Il Trono Sommerso di Grum’Arat',kind:'finale',x:50,y:10,links:['skull-sanctum'],closeup:'assets/optimized/dungeon-closeups/10-trono-sommerso.webp?v=3'},
    {id:'four-eyes-chapel',number:11,name:'La Cappella delle Quattro Pupille',kind:'chapel',x:23,y:23,links:['high-stairs'],closeup:'assets/optimized/dungeon-closeups/11-cappella-quattro-pupille.webp?v=3'}
  ]
};
